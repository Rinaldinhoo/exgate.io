                    ...
                    <div class="col-xl-12 col-xxl-4">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0 align-items-center">
                                <h6 class="mb-0 fw-bold">Negociação</h6>
                                <div class="btn btn-secondary">125X</div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between my-3">
                                                    ...
                                                    <span class="">{{$wallet->amount}} USDT</span>

                                                    <input id="wallet_74yr64" type="hidden" value="{{$wallet->amount}}"/>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between my-3">
                                                    ...
                                                    <span class="">{{$wallet->amount * 125}} USDT</span>
...
<!--
                                                    ...
                                                    <div class="mb-3 d-flex justify-content-between">
                                                        ...
                                                        <button wire:click.prevent="orderScoreBuy" type="submit" class="btn btn-light-success py-2 text-uppercase">COMPRAR/Long</button>

                                                        <button wire:click.prevent="orderScoreSell" type="submit" class="btn btn-light-danger py-2 text-uppercase">Vender/Short</button>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0 align-items-center">
                                <h6 class="mb-0 fw-bold ">Status Futuro</h6>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($ordersOpen as $order)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $currentPrice = $price; // Preço atual da criptomoeda
                                                            ...
                                                            <span class="px-1" style="color: {{$fontColor}};"> 
                                                                {{ number_format($profit, 2) }} USDT ({{ number_format($profitPercentage, 2) }}%) 
                                                            </span>

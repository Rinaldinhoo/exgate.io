    ...
    <div class="sidebar py-2 py-md-2 me-0 border-end" wire:ignore>
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-4 px-1">
                ...
                <li>
                    <!-- <a class="m-link active" href="/trade"> -->
                    <a class="m-link active" href="/trade">
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <div class="body-header border-bottom d-flex py-3">
            <div class="container-xxl">
                ...
                <div class="row align-items-center g-2">
                    <div class="col d-flex justify-content-between">
                    <button class="btn btn-primary btn-sm" id="graphic" style="cursor: pointer !important;">Abrir Gráfico</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-xxl">
                ...
                <div class="row g-3 mb-3 row-deck">
                    <div class="col-xl-12 col-xxl-8">
                        <div class="card">
                            <div class="card-body d-none" id="graph" wire:ignore>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between my-3">
                                                    ...
                                                    <span class="">
                                                        ...
                                                        {{ $calcMargem > 0 ? number_format($calcMargem, 2, '.', '') : number_format(($wallet->amountusdt+$calcMargem)-$calcMargem, 2, '.', '') }} USDT
                                                    </span>
                                                ...
                                                <form >
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label">Stop Gain/Stop Loss</label>

                                                        <div class="input-group mb-3">

                                                            <input type="text" class="form-control" placeholder="Stop Gain (Preço Bitcoin)" wire:model="takeProft">
                                                        </div>

                                                        <div class="input-group mb-3">

                                                            <input type="text" class="form-control" placeholder="Stop Loss (Preço Bitcoin)" wire:model="stopLoss">
                                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs tab-body-header rounded d-inline-flex mb-3" role="tablist">
                                    <li class="nav-item"><a class="nav-link @if($activeTab === 'Limit') active @endif" wire:click.prevent="setActiveTab('Limit')" data-bs-toggle="tab" href="#OpenOrder" role="tab">Ordens em Aberto ({{count($ordersOpen)}})</a></li>
                                    <!-- <li class="nav-item"><a class="nav-link @if($activeTab === 'Market') active @endif" wire:click.prevent="setActiveTab('Market')" data-bs-toggle="tab" href="#OrderHistory" role="tab">Ordens Fechadas ({{count($ordersClose)}})</a></li> -->
                                    <li class="nav-item"><a class="nav-link @if($activeTab === 'StopLimit') active @endif" wire:click.prevent="setActiveTab('StopLimit')" data-bs-toggle="tab" href="#TradeHistory" role="tab">Histórico de Negociações ({{count($ordersHistory)}})</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade @if($activeTab === 'Limit') show active @endif" id="OpenOrder">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($order['liquidation'] < 0)
                                                                <span style="color: red;">{{ abs($order['liquidation']) }}</span>
                                                            @else
                                                                <span style="color: red;">{{ $order['liquidation'] }}</span>
                                                            @endif
                                                        </td>
...
//                                                                   // $fontColor = 'green';
                                                            ...
                                                            <span class="px-1" style="color: {{$fontColor}};"> 
                                                                @if ($order['direction'] === 'buy')
                                                                    ...
                                                                    <!-- {{ number_format($profitPercentageTeste, 2)  }} USDT ({{ $profitPercentageTeste != 0 ? number_format($this->porcetagem, 2) : 0.00 }}%) -->
                                                                    {{ number_format($profitPercentageTeste, 2)  }} USDT
                                                                @else
                                                                    ...
                                                                    <!-- {{ number_format($profitPercentageTeste * -1, 2)  }} USDT ({{ $profitPercentageTeste != 0 ? number_format($this->porcetagem * -1, 2) : 0.00 }}%) -->
                                                                    {{ number_format($profitPercentageTeste * -1, 2)  }} USDT 
                                                                @endif
                                                            </span>

                                                        </td>
                                                        <td>
                                                            <button onclick="disableButton(this)" wire:click.prevent.debounce.500ms="orderClose({{$order->id}})" class="btn btn-form bg-danger text-white fechar"
                                                            wire:loading.attr="disabled"
                                                            @if($botaoBloqueado) disabled @endif
                                                            >Fechar</button>
                                                        </td>
                                                        <!--
                                                        <td>
                                    ...
                                    <div class="tab-pane fade @if($activeTab === 'Market') show active @endif" id="OrderHistory">
                                        <div class="table-responsive">
                                    ...
                                    <div class="tab-pane fade @if($activeTab === 'StopLimit') show active @endif" id="TradeHistory">
                                        <div class="table-responsive">
                                        <table id="ordertabthree" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{number_format(($order['total'] * $this->taxa) / 100, 2, '.', '')}} USDT</td>
                                                    ...
                                                    <td class="
                                                            @if($order['typestop'] === null)
                                                                <!-- Sem cor se typestop for null -->
                                                            @elseif($order['typestop'] == 'stop_loss')
                                                                <!-- Classe pode ser adicionada aqui se precisar -->
                                                            @else
                                                                <!-- Classe pode ser adicionada aqui se precisar -->
                                                            @endif
                                                        ">
                                                        @if($order['typestop'] == 'stop_loss')
                                                            <span style="color: green;">{{ $order['take_proft'] }}</span><br/> 
                                                            <span style="color: red;">{{ $order['stop_loss'] }}</span>
                                                        @else
                                                            <span style="color: green;">{{ $order['take_proft'] }}</span><br/>
                                                            <span style="color: red;">{{ $order['stop_loss'] }}</span>
                                                        @endif

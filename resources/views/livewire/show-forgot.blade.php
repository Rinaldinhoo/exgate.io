                                        ...
                                        <div class="card-body p-4">
                                            <form wire:submit.prevent="updatePassword">
                                                <div class="mb-3">
                                                    ...
                                                    <input wire:model="senha" type="password" class="form-control">
                                                    @error('senha') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label fs-6">Confirmar Senha</label>
                                                    <input wire:model="senhaconfirm" type="password" class="form-control">
                                                    @error('senhaconfirm') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                                <button type="submit" class="btn btn-primary text-uppercase py-2 fs-5 w-100 mt-2">Salvar Nova Senha</button>

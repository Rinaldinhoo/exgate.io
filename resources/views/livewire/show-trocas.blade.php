    ...
    <div class="sidebar py-2 py-md-2 me-0 border-end">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-4 px-1">
                ...
                <li>
                    <a class="m-link active" href="https://app.exgate.io/trocas">
                        <i class="icofont-chart-arrows-axis fs-4"></i> 
                        ...
                        <!-- <div class="col-xxl-5">
                            <div class="card">
                                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                    <h6 class="mb-0 fw-bold ">BTC/USDT Livro de Ofertas</h6> 
                                </div>
                                <div class="card-body">
                                    <ul class="nav nav-tabs tab-body-header rounded d-inline-flex" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#Both" role="tab">Ambos</a></li>
                                        ...
                                        <div class="tab-pane fade show active" id="Both">
                                            <table id="priceTableup" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                                ...
                                                <tbody>
                                                    @foreach($this->ordersOpen->where('direction', 'buy') as $open)
                                                    <tr>
                                                        <td><span class="color-price-up">{{number_format($open->price_open, 2, '.')}} USDT</span></td>
                                                        <td>{{number_format($open->amount, 8, '.')}} BTC</td>
                                                        <td>{{number_format($open->price_open * $open->amount, 2, '.')}} USDT</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                            ...
                                            <table id="priceTabledown" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                                ...
                                                <tbody>
                                                    @foreach($this->ordersOpen->where('direction', 'sell') as $open)
                                                    <tr>
                                                        <td><span class="color-price-down">{{number_format($open->price_open, 2, '.')}} USDT</span></td>
                                                        <td>{{number_format($open->amount, 10, '.')}} BTC</td>
                                                        <td>{{number_format($open->price_open * $open->amount, 2, '.')}} USDT</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            ...
                                            <table id="priceTableuponly" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><span class="color-price-up">{{number_format($open->price_open, 2, '.')}} USDT</span></td>
                                                        <td>{{number_format($open->amount, 10, '.')}} BTC</td>
                                                        <td>{{number_format($open->price_open * $open->amount, 8, '.')}} BTC</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                        ...
                        <div class="col-xxl-7">
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                    ...
                                    <h6 class="mb-0 fw-bold ">SPOT USDT/BRL</h6> 
                                </div>
                                <div class="card-body">
                                    <ul class="nav nav-tabs tab-body-header rounded d-inline-flex" role="tablist">
                                        <!-- <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#Limit" role="tab">Limite</a></li> -->
                                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#Limit" role="tab">Mercado</a></li>
                                        <!-- <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#Market" role="tab">Mercado</a></li> -->
                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <div class="d-flex align-items-center justify-content-between my-3">
                                                        <span class="small text-muted">Saldo</span>
                                                        <span class="">{{number_format($this->wallet->amountusdt, 2, '.')}} USDT</span>
                                                        <input type="hidden" id="amtusdt" value="{{$this->wallet->amountusdt}}" />
                                                    </div>
                                                    <form wire:submit.prevent="orderScoreBuy">
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Preço</span>
                                                            <!-- <input type="text" class="form-control" wire:model="pricebuy" id="pricebuy"> -->
                                                            <input type="text" class="form-control" disabled placeholder="Preço de Mercado">
                                                            <span class="input-group-text">USDT</span>
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Quantidade</span>
                                                            <input type="text" class="form-control" id="amountbuy">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="range" id="controleLimitBuy" class="form-range" min='1' max='5' value='1' step='1'>
                                                            <input type="hidden" id="pricenow" wire:model.debounce.1000ms="totalbuy">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Total</span>
                                                            <input type="text" class="form-control" id="totalbuy">
                                                            <span class="input-group-text">USDT</span>
                                                        </div>
                                                        <button type="submit" class="btn flex-fill btn-light-success py-2 fs-5 text-uppercase px-5 w-100">COMPRAR BRL</button>
                                                    </form>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="d-flex align-items-center justify-content-between my-3">
                                                        <span class="small text-muted">Saldo</span>
                                                        <span class="">{{number_format($this->wallet->amountbrl, 2, '.')}} BRL</span>
                                                        <input type="hidden" id="amtbrl" value="{{$this->wallet->amountbrl}}" />
                                                    </div>
                                                    <form wire:submit.prevent="orderScoreSell">
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Preço</span>
                                                            <!-- <input type="text" class="form-control" wire:model="pricesell" id="pricesell"> -->
                                                            <input type="text" class="form-control" disabled placeholder="Preço de Mercado">
                                                            <span class="input-group-text">USDT</span>
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Quantidade</span>
                                                            <input type="text" class="form-control" id="amountsell">
                                                            <span class="input-group-text">BRL</span>
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <div class="mb-2 d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <input type="range" id="controleLimitSell" class="form-range" min='1' max='5' value='1' step='1'>
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Total</span>
                                                            <input type="text" class="form-control" id="totalsell">
                                                            <span class="input-group-text">USDT</span>
                                                        </div>
                                                        <button type="submit" class="btn flex-fill btn-light-danger py-2 fs-5 text-uppercase px-5 w-100">VENDER BRL</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="tab-pane fade show active" id="Market">
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <form wire:submit.prevent="orderScoreBuyMarket">
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Preço</span>
                                                            <input type="text" class="form-control" disabled placeholder="Preço de Mercado">
                                                            <span class="input-group-text">USDT</span>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <button type="button" class="btn btn-outline-secondary">Quantidade</button>
                                                            <button type="button" class="btn btn-outline-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                                                              <span class="visually-hidden">Toggle Dropdown</span>
                                                            </button>
                                                            <ul class="dropdown-menu">
                                                              <li><a class="dropdown-item" href="#">Quantidade</a></li>
                                                              <li><a class="dropdown-item" href="#">Total</a></li>
                                                            </ul>
                                                            <input type="text" class="form-control" wire:model="amountbuymarket" id="amountbuymarket">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="range" id="controleMarketBuy" class="form-range" min='1' max='5' value='1' step='1'>
                                                        </div>
                                                        <button type="submit" class="btn flex-fill btn-light-success py-2 fs-5 text-uppercase px-5 w-100">COMPRAR BTC</button>
                                                    </form>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="d-flex align-items-center justify-content-between my-3">
                                                        <span class="small text-muted">Saldo</span>
                                                        <span class="">{{number_format($this->wallet->amount, 10, '.')}} BTC</span>
                                                    </div>
                                                    <form wire:submit.prevent="orderScoreSellMarket">
                                                        <input type="hidden" />
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Preço</span>
                                                            <input type="text" class="form-control" disabled placeholder="Preço de Mercado">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" wire:model="amountsellmarket">
                                                            <span class="input-group-text">BTC</span>
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <div class="mb-2 d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <input type="range" id="controleMarketSell" class="form-range" min='1' max='5' value='1' step='1'>
                                                        </div>
                                                        <button type="submit" class="btn flex-fill btn-light-danger py-2 fs-5 text-uppercase px-5 w-100">VENDER BTC</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div> -->
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                    <h6 class="mb-0 fw-bold ">Histórico de Ordem</h6> 
                                </div>
                                <div class="card-body">
                                    <ul class="nav nav-tabs tab-body-header rounded d-inline-flex mb-3" role="tablist">
                                        <!-- <li class="nav-item"><a class="nav-link " data-bs-toggle="tab" href="#OpenOrder" role="tab">Ordens Abertas({{$this->ordersOpen->count()}})</a></li> -->
                                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#OrderHistory" role="tab">Histórico de Ordem</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <!-- <div class="tab-pane fade show active" id="OpenOrder">
                                            <table id="ordertabone" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                                ...
                                                <tbody>
                                                    @foreach($this->ordersOpen as $open)
                                                    <tr>
                                                        <td>{{$open->created_at}}</td>
                                                        <td>BTC</td>
                                                        <td>{{$open->type == 'limit' ? 'Limite' : 'Mercado'}}</td>
                                                        <td><span class="{{ $open->direction == 'sell' ? 'color-price-down' : 'color-price-up' }}">{{$open->direction}}</span></td>
                                                        <td>{{number_format($open->price_open, 2, '.')}} USDT</td>
                                                        <td>{{number_format($open->amount, 8, '.')}} BTC</td>
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                            <a href="#" wire:click="deleteOrder({{ $open->id }})" class="btn btn-outline-secondary deleterow"><i class="icofont-ui-delete text-danger"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                        ...
                                        <!-- OpenOrdertab End -->
                                        <div class="tab-pane fade show active" id="OrderHistory">
                                            <div class="table-responsive">
                                            <table id="ordertabtwo" class="table-responsive priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>Data</th>
                                                        <th>Par</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>BRL</td>
                                                        <!-- <td>{{$history->type == 'limit' ? 'Limite' : 'Mercado'}}</td> -->
                                                        ...
                                                        <!-- <td>{{$history->executed ? 'Sim' : 'Não'}}</td> -->
                                                        <td>{{number_format($history->amount, 2, '.')}} BRL</td>
                                                        <td>{{number_format($history->amount / $history->price_open, 2, '.')}} USDT</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>

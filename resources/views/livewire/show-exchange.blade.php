    ...
    <div class="sidebar py-2 py-md-2 me-0 border-end">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-4 px-1">
                ...
                <li>
                    <a class="m-link active" href="https://app.exgate.io/exchange">
                        <i class="icofont-chart-arrows-axis fs-4"></i> 
                ...
                <div class="container-xxl">
                    <div class="row align-items-center g-2">
                        ...
                        <div class="col-12 col-md-6 text-md-end">
                            <button type="button" class="btn btn-dark lift">Gerar Relatório</button>
                        </div>
                    </div> <!-- Row end  -->
                </div>
            </div>
                        ...
                        <div class="col-xxl-7">
                            <div class="card mb-3">
                                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                    ...
                                    <h6 class="mb-0 fw-bold ">SPOT BTC/USDT</h6> 
                                </div>
                                <div class="card-body">
                                    <ul class="nav nav-tabs tab-body-header rounded d-inline-flex" role="tablist">
                                        ...
                                        <div class="tab-pane fade show active" id="Limit">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="d-flex align-items-center justify-content-between my-3">
                                                        <span class="small text-muted">Saldo</span>
                                                        <span class="">{{ substr($this->wallet->amount, 0, 10) }} BTC</span>
                                                        <input type="hidden" id="amtbtc" value="{{$this->wallet->amount}}" />
                                                    </div>
                                            ...
                                            <table id="ordertabtwo" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{number_format($history->amount, 8, '.')}} BTC</td>

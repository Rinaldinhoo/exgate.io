        ...
        <div class="body-header border-bottom d-flex py-3">
            <div class="container-xxl">
                <div class="row align-items-center">
                    <div class="col">
                        <h1 class="h4 mt-1">Indique e Ganhe</h1>
                    </div>
                </div> <!-- Fim da Linha  -->
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center">
                                <p class="card-text font-weight-bold">Seu link de divulgação é:<br/><span id="linkDivulgacao" class="font-weight-bold">https://app.exgate.io/register?aff={{$user->code}}</span></p>
                                <button class="btn btn-warning" onclick="copiarLink()">Copiar link de afiliado</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                <h5 class="card-title font-weight-bold">Comissões Total</h5>
                                <p class="card-text text-primary font-weight-bold">$ {{number_format($wallet->cpatotal, 2, ',', '.')}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                <h5 class="card-title font-weight-bold">Indicados</h5>
                                <p class="card-text text-primary font-weight-bold">{{$affList->count()}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                <h5 class="card-title font-weight-bold">Comissão</h5>
                                <p class="card-text text-primary font-weight-bold">$ {{number_format($wallet->amountcpa, 2, ',', '.')}}</p>
                                <button wire:click="rescueComission" type="submit" class="btn btn-warning">Resgatar Comissão</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-striped table-light">
                                    ...
                                    <tbody>
                                        @foreach($affList as $index => $af)
                                        <tr>
                                            <th scope="row">{{$index + 1}}</th>
                                            <td>{{$af->email}}</td>
                                            <td>{{$af->name}}</td>
                                            @if ($user->code == $af->aflevel1)
                                                <td>$ {{number_format($af->sumcpalvl1, '2', '.')}}</td>
                                            @else
                                                <td>$ {{number_format($af->sumcpalvl2, '2', '.')}}</td>
                                            @endif
                                            <td>{{$af->created_at}}</td>
                                        </tr>
                                        @endforeach

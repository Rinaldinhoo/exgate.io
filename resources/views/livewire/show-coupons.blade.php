    ...
    <div class="sidebar py-2 py-md-2 me-0 border-end">
        <div class="d-flex flex-column h-100">
            ...
            <a href="index.html" class="mb-0 brand-icon">
                ...
                <span class="logo-text">Coinnexc</span>
            </a>
            <!-- Menu: main ul -->
            <ul class="menu-list flex-grow-1 mt-4 px-1">
                ...
                <li>
                    <a class="m-link" href="{{route('trade')}}">
                        ...
                        <div class="ms-2" ><h6 class="mb-0">Mercado</h6><small class="text-muted">Negociações</small></div>
                    </a>
                </li>
                            ...
                            <div class="card-body p-3">
                                <div class="row g-3">
                                    <div class="d-none d-lg-block col-lg-2 text-start">
                                        <h6 class="px-2 text-primary mb-0">Faça um depósito!</h6>
                                            ...
                                            <li class="col">
                                                <a href="#" class="d-flex color-700">
                                                    ...
                                                    <div class="flex-fill text-truncate">
                                                        ...
                                                        <small class="text-muted">No que posso ajudá-lo?</small>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="col">
                                                <a href="#" class="d-flex color-700">
                                                    ...
                                                    <div class="flex-fill text-truncate">
                                                        <p class="h6 mb-0">Item</p>
                                                        <small class="text-muted">Descrição do item</small>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="col">
        ...
        <div class="body-header border-bottom d-flex py-3">
            <div class="container-xxl">
                <div class="row align-items-center">
                    <div class="col">
                        <h1 class="h4 mt-1">Centro de Recompensas</h1>
                    </div>
                    <div class="col-auto">
                        <button type="button" class="btn btn-dark lift"  data-bs-toggle="modal" data-bs-target="#VoucherModal">Inserir Código do Voucher</button>
                    </div>
                </div> <!-- Fim da Linha  -->
            </div>
        </div>
        ...
        <div class="body d-flex py-3">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-lg-4">
                                    <label class="form-label">Tipo de Voucher</label>
                                    <select class="form-select">
                                        <option selected>Todos</option>
                                        <option value="1">Voucher de Bônus</option>
                                        <option value="2">Voucher de Cashback</option>
                                        <option value="3">Voucher de Teste</option>
                                        <option value="4">Voucher VIP</option>
                                    </select>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select class="form-select">
                                        <option selected>Mais Recentes para Mais Antigos</option>
                                        <option value="1">Mais Antigos para Mais Recentes</option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-3">
                    <div class="col-lg-12 col-xl-12 col-xxl-6">
                        <div class="card p-3 flex-sm-row align-items-center coupon">
                            <div class="col-12 col-sm-3 text-sm-center price">
                                <h4>200</h4>
                                <span class="text-muted">USDT</span>
                            </div>
                            <div class="col-12 col-sm-9 px-2 px-sm-3 px-lg-4 px-xl-5 px-xxl-4 detail">
                                <h5 class="mb-0">Voucher de 0% de Juros</h5>
                                <span class="text-muted mb-2 d-block">Data de Expiração: 2021-06-03</span>
                                <div class="row g-2 row-cols-2">
                                    <div class="col">Tempo de Recompensa: 7 dias</div>
                                    <div class="col">Margem Isolada</div>
                                    <div class="col">Desconto em Empréstimos</div>
                                    <div class="col">Todos os Tipos de Voucher</div>
                                </div>
                                <button type="button" class="btn btn-light-warning text-uppercase fs-6 px-4 mt-3">Resgatar</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-xl-12 col-xxl-6">
                        <div class="card p-3 flex-sm-row align-items-center coupon">
                            ...
                            <div class="col-12 col-sm-9 px-2 px-sm-3 px-lg-4 px-xl-5 px-xxl-4 detail">
                                <h5 class="mb-0">Voucher de Cashback</h5>
                                <span class="text-muted mb-2 d-block">Data de Expiração: 2021-06-04</span>
                                <div class="row g-2 row-cols-2">
                                    <div class="col">Tempo de Recompensa: 7 dias</div>
                                    <div class="col">Negociação Futura</div>
                                    <div class="col">Cashback 2 vezes</div>
                                    <div class="col">Todos os Tipos de Voucher</div>
                                </div>
                                <button type="button" class="btn btn-light-warning text-uppercase fs-6 px-4 mt-3">Resgatar</button>
                            </div>
                    ...
                    <div class="col-lg-12 col-xl-12 col-xxl-6">
                        <div class="card p-3 flex-sm-row align-items-center coupon">
                            ...
                            <div class="col-12 col-sm-9 px-2 px-sm-3 px-lg-4 px-xl-5 px-xxl-4 detail">
                                <h5 class="mb-0">Atualização VIP</h5>
                                <span class="text-muted mb-2 d-block">Data de Expiração: 2021-06-07</span>
                                <div class="row g-2 row-cols-2">
                                    <div class="col">Tempo de Recompensa: 1 dia</div>
                                    <div class="col">Assinatura VIP</div>
                    ...
                    <div class="col-lg-12 col-xl-12 col-xxl-6">
                        <div class="card p-3 flex-sm-row align-items-center coupon">
                            ...
                            <div class="col-12 col-sm-9 px-2 px-sm-3 px-lg-4 px-xl-5 px-xxl-4 detail">
                                <h5 class="mb-0">Fundo de Teste</h5>
                                <span class="text-muted mb-2 d-block">Data de Expiração: 2021-06-06</span>
                                <div class="row g-2 row-cols-2">
                                    <div class="col">Tempo de Recompensa: 5 dias</div>
                                    <div class="col">Negociação à Vista</div>
                                    <div class="col">Teste</div>
                                    <div class="col">Todos os Tipos de Voucher</div>
                                </div>
                                <button type="button" class="btn btn-light-success text-uppercase fs-6 px-4 mt-3">XR0058</button>
                            </div>
                        </div>
                    </div>
            </div>
                        ...
                        <div class="modal-body custom_setting">
                            ...
                            <div class="dynamic-block py-3">
                                <ul class="list-unstyled choose-skin mb-2 mt-1">
                                    <li data-theme="dynamic"><div class="dynamic"><i class="icofont-paint me-2"></i> Clique para Configuração Dinâmica</div></li>
                                </ul>

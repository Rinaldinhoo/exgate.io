...
<div id="cryptoon-layout" class="theme-orange">
            ...
            <div class="container-xxl">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent align-items-center ">
                                <h6 class="mb-0 fw-bold">Autenticação (2FA)</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Chave de segurança</span>
                                                    <span class="text-muted small">Proteja sua conta com uma chave de segurança.</span>
                                                </div>
                                            </div>   
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="px-2">Desativar</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                                            <button type="button" class="btn flex-fill btn-light-warning py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end" data-bs-toggle="modal" data-bs-target="#EnableModal">HABILITAR</button>
                                        </div>
                                    </div>
                                </div> -->
                                <div class="border-bottom py-2 mb-2">
                                    <div class="row justify-content-between">
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Autenticador Google (recomendado)</span>
                                                    <span class="text-muted small">Proteja sua conta e transações.</span>
                                                </div>
                                            </div>   
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="px-2">Ativado</span>
                                                @else
                                                <i class="icofont-close-circled fs-5 text-danger"></i>
                                                <span class="px-2">Desativado</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                                        @if ($this->user->is2fa == true)
                                            <button type="button" class="btn flex-fill btn-light-danger py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end" data-bs-toggle="modal" data-bs-target="#confirmacaoExclusaoModal">EXCLUIR</button>
                                        @else
                                            <button type="button" class="btn flex-fill btn-light-warning py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end" data-bs-toggle="modal" data-bs-target="#EnableModal">HABILITAR</button>
                                        @endif
                                        </div>
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Verificação de número de telefone</span>
                                                    <span class="text-muted small">Proteja sua conta e transações.</span>
                                                </div>
                                            </div>   
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-xl-4">
                                            <button type="button" class="btn flex-fill btn-light-danger py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end" data-bs-toggle="modal" data-bs-target="#RemoveModal">REMOVER</button>
                                            <button type="button" class="btn flex-fill btn-light-success py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end mx-2" data-bs-toggle="modal" data-bs-target="#ChangeModal">MUDAR</button>
                                        </div>
                                    </div>
                                </div> -->
                                <div class="py-2">
                                    <div class="row justify-content-between">
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Verificação de endereço de e-mail</span>
                                                    <span class="text-muted small">Proteja sua conta e transações.</span>
                                                </div>
                                            </div>   
                                        </div>
                ...
                <div class="row align-item-center mb-3">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent align-items-center ">
                                <h6 class="mb-0 fw-bold">Segurança Avançada</h6>
                            </div>
                            <div class="card-body">
                                <div class="border-bottom py-2 mb-2">
                                    <div class="row justify-content-between">
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                <i class="icofont-ui-lock fs-5 text-primary"></i>
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Excluir Conta</span>
                                                    <span class="text-muted small">A senha de login é usada para acessar sua conta.</span>
                                                </div>
                                            </div>   
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                                            <button type="button" class="btn flex-fill btn-light-danger py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end" data-bs-toggle="modal" data-bs-target="#DeleteAccountModal">DELETAR</button>
                                        </div>
                                    </div>
                                </div>    
                                <div class="border-bottom py-2 mb-2">
                                    <div class="row justify-content-between">
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                <i class="icofont-ui-lock fs-5 text-primary"></i>
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Senha de login</span>
                                                    <span class="text-muted small">A senha de login é usada para fazer login em sua conta.</span>
                                                </div>
                                            </div>   
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                                            <button type="button" class="btn flex-fill btn-light-success py-2 fs-6 text-uppercase px-3 mt-2 mt-lg-0 float-lg-end" data-bs-toggle="modal" data-bs-target="#ChangeModal">MUDAR</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="border-bottom py-2 mb-2">
                                    <div class="row justify-content-between">
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column px-2">
                                                    <span class="fw-bold">Lista branca de retirada</span>
                                                    <span class="text-muted small">endereços de retirada na lista de permissões.</span>
                                                </div>
                                            </div>   
                                        </div>
                                        <div class="col-lg-4 col-xl-4">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            <div class="mb-3 text-center">
                                <label class="form-label">Defina seu Código</label></br>
                                <img src="{{$this->qrCodeUrl}}" width="250" />
                                <br/>
                                <div class="form-text">Código: <span id="copycode">{{$this->user->code2fa}}</span></div>
                                <a href="#" class="btn btn-primary"  onclick="copyCode()">Copiar Código</a><br/>
                                <br/>
                                <div class="form-text">Nós nunca compartilharemos seu email com outras pessoas.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Confirme seu Código para Habilitar</label>
                                <br> <!-- Adiciona uma quebra de linha para movê-lo para baixo -->
                                <input type="text" class="form-control" id="codeCheck">
                            </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                        <button type="button" id="checkfa" class="btn btn-primary">Ativar</button>
                    </div>
                </div>
                </form>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Tem certeza de que deseja excluir sua conta? Esta ação é irreversível e todos os dados associados à sua conta serão perdidos.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-danger" id="confirmarExclusaoAccBtn" >Excluir Conta</button>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="confirmacaoExclusaoModalLabel">Desabilitar 2FA</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
      </div>
      <div class="modal-body">
        Tem certeza que deseja desabilitar a autenticação em duas etapas?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>

<div id="cryptoon-layout" class="theme-orange">
    ...
    <div class="main px-lg-4 px-md-4">
        ...
        <!-- Corpo: Título do Cabeçalho -->
        <div class="body-header border-bottom d-flex py-3">
            <div class="container-xxl">
                <div class="row align-items-center">
                    <div class="col-xl-12">
                        <!-- Subtítulo -->
                        <h1 class="h4 mt-1">Verificação Pessoal</h1>
                    </div>
                </div> <!-- Fim da Linha  -->
            </div>
        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent align-items-center ">
                                <h6 class="mb-0 fw-bold">Verificação</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-xl-3">
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-3">Verificado</h6>
                                            <span class="text-muted my-1"><i class="icofont-check-circled fs-5 text-success px-2"></i>Informações pessoais</span>
                                            <span class="text-muted my-1"><i class="icofont-check-circled fs-5 text-success px-2"></i>Documento de identificação emitido pelo governo</span>
                                            <span class="text-muted my-1"><i class="icofont-check-circled fs-5 text-success px-2"></i>Reconhecimento Facial</span>

                                            @if ($document)
                                                @if($document->status == 'Aprovado')
                                                <span class="text-muted my-1"><i class="icofont-check-circled fs-5 text-success px-2"></i>Documento - Frente</span>
                                                <span class="text-muted my-1"><i class="icofont-check-circled fs-5 text-success px-2"></i>Documento - Verso</span>
                                                <span class="text-muted my-1"><i class="icofont-check-circled fs-5 text-success px-2"></i>Selfie Segurando Documento</span>
                                                @elseif($document->status == 'Recusado')
                                                <br>
                                                <span class="text-muted my-1"><b style="color:#fa0">Recusado:<br/>{{$document->observation}}</b></span>
                                                <br>
                                                <form action="https://app.exgate.io/upload-arquivos" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                                            @csrf
                                                    <span class="text-muted my-1">
                                                        <i class="icofont-clock-time fs-5 text-info px-2"></i>Documento - Frente
                                                    </span>
                                                    <input type="file" name="documentfront">
                                                    @error('documentfront') <span class="text-danger">{{ $message }}</span> @enderror

                                                    <span class="text-muted my-1">
                                                        <i class="icofont-clock-time fs-5 text-info px-2"></i>Documento - Verso
                                                    </span>
                                                    <input type="file" name="documentback">
                                                    @error('documentback') <span class="text-danger">{{ $message }}</span> @enderror

                                                    <span class="text-muted my-1">
                                                        <i class="icofont-clock-time fs-5 text-info px-2"></i>Selfie Segurando Documento
                                                    </span>
                                                    <input type="file" name="selfiedocument">
                                                    @error('selfiedocument') <span class="text-danger">{{ $message }}</span> @enderror
                                                ...
                                                @else
                                                <br>
                                                <span class="text-muted my-1"><b style="color:#fa0">Aguarde Aprovação</b></span>
                                                <br>
                                                <span class="text-muted my-1"><i class="icofont-exclamation-circle fs-5 text-danger px-2"></i>Documento - Frente</span>
                                                <span class="text-muted my-1"><i class="icofont-exclamation-circle fs-5 text-danger px-2"></i>Documento - Verso</span>
                                                <span class="text-muted my-1"><i class="icofont-exclamation-circle fs-5 text-danger px-2"></i>Selfie Segurando Documento</span>
                                                @endif
                                            @else
                                            <br />
                                            <div>
                                    ...
                                    <div class="col-xl-9">
                                        <h6 class="mb-3">Recursos Atuais</h6>
                                        <div class="row g-3 row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-2 row-cols-xxl-3">
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Limites de Depósito e Retirada em Fiat</span>
                                                        <span class="fw-bold">$ 6K Diariamente</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Limite de Depósito em Criptomoedas</span>
                                                        <span class="fw-bold">Ilimitado</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Limite de Retirada em Criptomoedas</span>
                                                        <span class="fw-bold">100 BTC Diariamente</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Limites de Transações P2P</span>
                                                        <span class="fw-bold">Ilimitado</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Outros Recursos</span>
                                                        <span class="fw-bold">LPD/OTC/Cartão Cryptoon</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Aplicação para ICO</span>
                                                        <span class="fw-bold">Ilimitada</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Aplicação de Empréstimo</span>
                                                        <span class="fw-bold">Ilimitada</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted">Transação de Pagamento</span>
                                                        <span class="fw-bold">$20K Diariamente</span>
                                                        <div class="d-flex flex-column">
                                                            <span class="text-muted">Negociação Futura</span>
                                                            <span class="fw-bold">Ilimitada</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex flex-column">
                                                            <span class="text-muted">Stand Spot</span>
                                                            <span class="fw-bold">Ilimitado Diariamente</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
       ...
       <div class="modal fade right" id="Settingmodal" tabindex="-1"  aria-hidden="true">
        ...
        <div class="modal fade" id="EnableModal" tabindex="-1"  aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Ativar Configurações</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label class="form-label">Defina seu Código</label>
                                <input type="text" class="form-control">
                                <div class="form-text">Nós nunca compartilharemos seu email com outras pessoas.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Confirme seu Código</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" >
                                <label class="form-check-label">Marque-me</label>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="ChangeModal" tabindex="-1"  aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Alterar Configurações</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label class="form-label">Detalhe Antigo</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Novo Detalhe</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" >
        ...
        <div class="modal fade" id="RemoveModal" tabindex="-1"  aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Remover Configurações</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                    </div>
                    <div class="modal-body">
                        <i class="icofont-ui-delete fs-2 text-danger d-flex justify-content-center"></i>
                        <h2 class="my-3 text-center">Você tem certeza de que deseja remover?</h2>
                        <p class="text-muted">Retiradas e vendas P2P serão desabilitadas por 24 horas após você fazer essa alteração para proteger sua conta.</p>
                        <p class="text-muted">São necessários dois métodos de verificação de segurança para retiradas e outras ações. Usar apenas um método de verificação limitará suas retiradas.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                        <button type="button" class="btn btn-primary">Salvar Alteração</button>
        ...
        <!-- Modal -->
<div class="modal fade" id="analiseModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Análise de Documentos</h5>
